...
describe("AdaptersClient", () => {
  ...
  it("shows real-model status separately and preserves exact eligibility reason", async () => {
    mockAdapter(adapter({ deterministic_coverage_status: "complete", real_model_coverage_status: "incomplete", real_model_behavioral_required: true, activation_eligibility_reason: "real_model_not_run" }));
    renderWithQuery();
