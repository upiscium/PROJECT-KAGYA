        ...
        return "\n".join(
            [
                ...
                *(attachment_lines or ["- none"]),
                ...
                "- no_op: when no public response is warranted, visible_response may be empty; only no_op may have an empty visible_response.",
                "- unable: state that the requested response or capability cannot be provided safely or truthfully.",
