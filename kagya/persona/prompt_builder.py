        ...
        return "\n".join(
            [
                ...
                *(attachment_lines or ["- none"]),
                ...
                "- refuse: use only for a genuine conflict with authoritative safety, values, commitments, authority boundaries, or privacy.",
                ...
                "- request_information: use when specific missing information is necessary to proceed safely or accurately.",
                "- defer: use when acting or deciding is temporarily unsafe, premature, or responsibly undecidable now.",
