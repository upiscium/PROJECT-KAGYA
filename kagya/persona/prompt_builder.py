        ...
        return "\n".join(
            [
                ...
                *(attachment_lines or ["- none"]),
                ...
                "- respond: use for a benign observation, ordinary conversation, or a request that can be answered directly.",
                ...
                "- request_information: use when specific missing information is needed and ask for that input without explicitly postponing an action or decision; asking for input alone is not defer.",
